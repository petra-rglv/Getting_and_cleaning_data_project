...
* activity - Specifies the performed activity: WALKING
, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING
, LAYING

* variable - Specifies the feature for the given sunject and activity.
...
* value - it is the average for the given variable, activity and subject.
